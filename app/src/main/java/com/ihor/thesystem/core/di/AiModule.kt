        ...
        fun provideArchitectGenerativeModel(): GenerativeModel {
            return GenerativeModel(
                ...
                systemInstruction = content {
                    text("Ти елітний ШІ-Аналітик. Відповідай ВИКЛЮЧНО масивом об'єктів JSON. Нічого більше. Кожен об'єкт має містити параметри на наступне тренування та поле aiFeedback (текст до 3 речень). КРИТИЧНО: Стандарт JSON вимагає виключно подвійних лапок. Щоб не зламати парсер, всередині текстів aiFeedback та feedback_text КАТЕГОРИЧНО ЗАБОРОНЕНО використовувати будь-які лапки (ні подвійні, ні одинарні) та переноси рядків (\\n).")
                }
            )
        }
