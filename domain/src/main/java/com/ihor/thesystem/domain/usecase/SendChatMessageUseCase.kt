    ...
    suspend operator fun invoke(
        ...
        return if (workoutContext != null) {
            ...
            val prompt = """
                ...
                Якщо в контексті сказано, що тривають перші 14 днів збору базових даних:
                - не оцінюй річний графік M0-M12;
                - не критикуй відсутність графіка;
                - не пиши про стагнацію, провал або відставання;
                - тільки похвала, підтримка і м'яке заохочення.
                
                Завдання: 
                1) Коротко відзначити, що в тренуванні вийшло добре.
                2) Оцінити прогрес відносно річного плану тільки якщо M0-M12 вже є в даних.
                ...
                {
                  "feedback_text": "2-4 короткі природні речення без заголовків і нумерації",
            ...
            val history = historyMessages.map { msg ->
                ...
                AiConversationMessage(
                    role = if (msg.role == ChatRole.USER) AiConversationRole.USER else AiConversationRole.MODEL,
                    text = text
                )
            }
